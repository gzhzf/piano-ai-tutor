...
INTENT_KEYWORDS = {
    "lesson_plan": {
        ...
        "sub_keys": {
            ...
            "欢乐颂": ["欢乐颂", "贝多芬"],
            "小羊羔": ["小羊羔", "玛丽有只小羊羔", "玛丽"],
            "巴赫": ["巴赫小步舞曲", "巴赫g大调", "巴赫", "小步舞曲"],
            "巴赫Anh115": ["anh115", "anh.115", "g小调小步舞"],
            "巴赫Anh116": ["anh116", "anh.116"],
            "巴赫Anh119": ["anh119", "anh.119", "波兰舞曲"],
            "巴赫Anh122": ["anh122", "anh.122", "d大调进行曲"],
            "两只老虎": ["两只老虎", "frere"],
            ...
            "车尔尼": ["车尔尼", "czerny", "599"],
            "小汤": ["小汤", "汤普森", "thompson"],
            "央音": ["央音", "中央音乐", "考级", "咏叹调", "古利特"],
            "小奏鸣曲": ["小奏鸣曲", "克莱门蒂", "clementi", "库劳", "kuhlau"],
            "致爱丽丝": ["致爱丽丝", "for elise", "爱丽丝"],
    ...
    "teaching_assist": {
        "keywords": ["舞蹈路线", "路线图", "前后测", "练习方案", "个性化",
                     "巴赫是谁", "小步舞曲是什么", "四手联弹", "联弹",
                     "课前", "课后", "备课", "学情报告"],
        "sub_keys": {
            "舞蹈路线图": ["舞蹈路线", "路线图", "舞蹈图"],
            "节奏游戏": ["节奏游戏", "课堂游戏", "游戏设计"],
